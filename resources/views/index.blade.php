...
<head>
    ...
    <link rel="stylesheet" href="{{asset('common-assets/css/bootstrap-custom.css')}}">
    <link rel="stylesheet" href="{{asset('common-assets/vendor/overlayscrollbars/css/OverlayScrollbars.css')}}">
    <link rel="stylesheet" href="{{asset('common-assets/css/yaybar.css')}}">
    {{-- plugin --}}
...
class="rui-no-transition rui-navbar-autohide rui-section-lines">
    ...
    <script src="{{asset('common-assets/vendor/feather-icons/dist/feather.min.js')}}"></script>
    <script src="{{asset('common-assets/vendor/overlayscrollbars/js/jquery.overlayScrollbars.min.js')}}"></script>
