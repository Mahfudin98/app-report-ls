            ...
            <ul>
                <li :class="
                    ...
                    <router-link :to="{ name: 'home' }">
                        <span class="yay-icon">
                            <span data-feather="home" class="rui-icon fas fa-home"></span>
                        </span>
                        <span>Dashboard</span>
                ...
                <!--Analisis Product-->
                <li :class="
                            this.$route.name == 'product.chart' ? 'yay-item-active' : ''
                        ">
                    <router-link :to="{ name: 'product.chart' }">
                        <span class="yay-icon">
                            <span data-feather="product.chart" class="rui-icon fas fa-chart-bar"></span>
                        </span>
                        <span>Product Analisis</span>
                        <span class="rui-yaybar-circle"></span>
                    </router-link>
                </li>
                <!-- report -->
                <li :class="
                    ...
                    <a href="#" class="yay-sub-toggle">
                        <span class="yay-icon">
                            <span data-feather="layers" class="rui-icon fas fa-layer-group"></span>
                        </span>
                        <span>Report</span>
                        <span class="rui-yaybar-circle"></span>
                    ...
                    <ul class="yay-submenu dropdown-triangle">
                        <li v-if="$can('read reports cs')" :class="
                                    this.$route.name == 'cs.report.data' ||
                                    this.$route.name == 'report.data.date'
                                        ? 'yay-item-active'
                                        : ''
                        ...
                        <li v-if="$can('read reports adv')" :class="
                                    this.$route.name == 'adv.report.data'
                                        ? 'yay-item-active'
                                        : ''
                                ">
                ...
                <!-- return -->
                <li v-if="$can('read reports returns')" :class="
                            this.$route.name == 'return.data'
                                ? 'yay-item-active'
                                : ''
                        ">
                    <router-link :to="{ name: 'return.data' }" class="active">
                        <span class="yay-icon">
                            <span data-feather="git" class="rui-icon fas fa-exchange-alt"></span>
                        </span>
                ...
                <!-- target -->
                <li v-if="authenticated.role == 0 || $can('read teams')" :class="
                            this.$route.name == 'target.data'
                                ? 'yay-item-active'
                                : ''
                        ">
                    <router-link :to="{ name: 'target.data' }" class="active">
                        <span class="yay-icon">
                ...
                <!-- teams -->
                <li v-if="$can('read teams')" :class="
                            this.$route.name == 'teams.data'
                                ? 'yay-item-active'
                                : ''
                        ">
                    <router-link :to="{ name: 'teams.data' }" class="active">
                        <span class="yay-icon">
                            <span data-feather="home" class="rui-icon fas fa-users"></span>
                        </span>
                        <span>Team</span>
                        <span class="rui-yaybar-circle"></span>
                    </router-link>
                ...
                <!-- inventory -->
                <li v-if="$can('read inventories')" :class="
                            this.$route.name == 'inventory.data'
                                ? 'yay-item-active'
                                : ''
                        ">
                    <router-link :to="{ name: 'inventory.data' }" class="active">
                        <span class="yay-icon">
                ...
                <li v-if="$can('read inventories')" :class="
                            this.$route.name == 'customer.data'
                                ...
                                : ''
                        ">
                    <router-link :to="{ name: 'customer.data' }" class="active">
                        <span class="yay-icon">
                ...
                <!-- position -->
                <li v-if="$can('read positions')" :class="
                            this.$route.name == 'position.data'
                                ? 'yay-item-active'
                                : ''
                        ">
                    <router-link :to="{ name: 'position.data' }" class="active">
                        <span class="yay-icon">
                ...
                <!-- product -->
                <li v-if="$can('read products')" :class="
                            this.$route.name == 'product.data'
                                ? 'yay-item-active'
                                : ''
                        ">
                    <router-link :to="{ name: 'product.data' }" class="active">
                        <span class="yay-icon">
                ...
                <!-- permissions -->
                <li v-if="authenticated.role == 0 || $can('create teams')" :class="
                            this.$route.name == 'role.permissions'
                                ? 'yay-item-active'
                                : ''
                        ">
                    <router-link :to="{ name: 'role.permissions' }" class="active">
                        <span class="yay-icon">
