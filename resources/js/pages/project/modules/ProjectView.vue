...
<div class="row">
    ...
    <div class="container-fluid" v-if="viewReportWebs.data != null">
        <div class="row vertical-gap sm-gap justify-content-center">
            <div class="col-sm-6">
                <b-card bg-variant="primary" text-variant="white" :title="'Report URL ' + urlShow">
                    <b-card-text>
            ...
            <div class="col-sm-6">
                <b-card border-variant="primary" :header="'Report Tanggal ' + viewReportWebs.data.date" header-bg-variant="primary" header-text-variant="white" align="center">
