...
<div class="card">
    <div class="card-header">
        <h5 class="card-title">Data Report CS</h5>
    </div>
    <div class="card-body" v-if="$can('create reports cs')">
        <calender />
    </div>
    <div class="card-body" v-if="authenticated.position_id == 13">
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="table-responsive">
            <b-table :items="listCS.data" :fields="fields" head-variant="light" show-empty>
                <template #cell(index)="data">
                    {{ data.index + 1 }}
                </template>
                <template #cell(view)="row">
                    <router-link class="btn btn-primary btn-long btn-round" :to="{ name: 'report.vieworder', params: { id: row.item.id }}">
    ...
    <div class="card-body" v-if="authenticated.position_id == 1 || authenticated.position_id == 2 || authenticated.position_id == 6 || authenticated.position_id == null">
        <div class="table-responsive">
        ...
        <div class="container-fluid" v-if="authenticated.position_id == 13">
            ...
            <div class="table-responsive">
                <b-table :items="listCS.data" :fields="fields" head-variant="light" show-empty>
                    ...
                    <template #cell(view)="row">
                        <router-link class="btn btn-brand btn-long btn-round" :to="{
