...
export default {
    ...
    created() {
        this.getCalendarCsReports(this.$route.params.id).then(res => {
    ...
    watch: {
        id() {
            this.getCalendarCsReports(this.$route.params.id);
        }
    },
    computed: {
        ...mapState("csReport", {
    ...
    methods: {
        handleDateClick: function(arg) {
            this.$router.push(
                "/cs-report/" + this.$route.params.id + "/" + arg.dateStr
            );
        },
        ...mapActions("csReport", ["getCalendarCsReports"])
    }
};
</script>
<template>
