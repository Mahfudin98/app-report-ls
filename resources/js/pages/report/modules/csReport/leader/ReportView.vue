...
<main>
    ...
    <customer-add />
    <div class="row">
        <div class="col-12" v-if="viewDetail == ''">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <button v-b-modal.addReportCS type="button" class="btn btn-primary">
                        ...
                        <span class="align-middle">Add Report CS</span>
                    </button>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-4 col-xl-4" v-if="viewDetail != ''">
            <div class="card">
                ...
                <div class="card-body px-4 pt-2">
                    <table class="table table-sm mt-2 mb-4">
                        <tbody>
                            <tr>
                                <th>Chat/Lead</th>
                                <td>{{ viewDetail.chat }}</td>
                            </tr>
                            <tr>
                                <th>Transaksi</th>
                                <td>{{ viewDetail.transaksi }}</td>
                            </tr>
                            <tr>
                                <th>Omset</th>
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item px-4 pb-4">
                        ...
                        <p v-if="viewDetail.description != null" v-html="viewDetail.description"></p>
                        <p v-if="viewDetail.description == null">
        ...
        <div class="col-12 col-md-8 col-lg-8" v-if="viewDetail != ''">
                ...
                <div class="card">
                    ...
                    <div class="card-body px-4 pt-2">
                        <div class="accordion" role="tablist">
                            <div class="table-responsive">
                                <b-table borderless :items="viewDetail.order" :fields="data" show-empty>
    ...
    <!-- <div class="rui-page-content">
        <div class="container-fluid">
            <div class="row xs-gap" v-if="viewDetail == ''">
            ...
            <div class="rui-profile row vertical-gap" v-if="viewDetail != ''">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="accordion list-group list-group-flush rui-profile-task-list" id="accordionExample">
                                <div class="accordion-group" v-for="(row, index) in viewDetail.order" :key="index">
...
import CustomerAdd from "./AddReportCSCustomer.vue";
import ReportsCSAdd from "./AddReportCS.vue";
...
export default {
    ...
    computed: {
        ...
        getOrder() {
            const status = this.viewDetail.order;
