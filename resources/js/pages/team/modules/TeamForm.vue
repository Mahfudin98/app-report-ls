        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body mnt-6 mnb-6">
                    ...
                    <div
                        class="mb-3"
                        :class="{ 'has-error': errors.tempat_lahir }"
                    >
                    ...
                    <div
                        class="mb-3"
                        :class="{ 'has-error': errors.tanggal_lahir }"
                    >
            ...
            <div class="card">
                <div class="card-body mnt-6 mnb-6">
                    ...
                    <div class="mb-3" :class="{ 'has-error': errors.password }">
                        ...
                        />
                        <p v-if="this.$route.name == `teams.edit`">
                    ...
                    <div
                        ...
                        v-if="authenticated.role == 0 || $can('edit teams')"
                    >
                    ...
                    <div v-if="authenticated.role == 0 || $can('edit teams')">
                        <div
                            class="mb-3"
                            v-if="
                                team.position_id == 12 ||
