...
import AllDataCSReport from "./pages/report/modules/csReport/leader/ReportAllCS";
import AllDataCSReportCalendar from "./pages/report/modules/csReport/leader/ReportAllCSCalendar.vue";
import ViewCSReportAll from "./pages/report/modules/csReport/leader/ReportView.vue";
...
import EditOrder from "./pages/report/modules/csReport/components/EditOrder.vue";
// advReport
  ...
  routes: [
    ...
    // report route
    {
      ...
      children: [
        ...
        {
          path: "/all-cs-report",
          name: "all.cs.report.data",
          component: AllDataCSReport,
          meta: { title: "Manage Report CS" }
        },
        {
          path: "/all-cs-report/:id",
          name: "all.cs.report.data.calendar",
          component: AllDataCSReportCalendar,
          meta: { title: "Manage Report CS" }
        },
        {
          path: "/cs-report/:id/:date",
          name: "report.id.data.date",
          component: ViewCSReportAll,
          meta: { title: "Manage Report" }
        },
        // end leader
        {
        ...
        {
          path: "/cs-report/edit-order/:id",
          name: "cs.report.edit.order",
          component: EditOrder,
          meta: { title: "Edit Order" }
        },
        // adv report
      ...
      children: [
        {
          ...
          meta: { title: "Manage Web Statistik" }
        },
        {
          path: "edit/:id",
          name: "project.edit",
