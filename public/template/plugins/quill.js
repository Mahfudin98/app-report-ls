        ...
        /******/ [
            ...
            /***/ function(module, exports) {
                ...
                function create(input, value) {
                    ...
                    var BlotClass = match;
                    var node =
                        input instanceof Node ? input : BlotClass.create(value);
                    ...
                    _createClass(Quill, [
                        ...
                        },
                        {
                            ...
                            value: function deleteText(index, length, source) {
                                ...
                                var change = this.editor.deleteText(
                                    index,
                                    length,
                                    source
                                );
                        ...
                        },
                        {
                            ...
                            value: function removeFormat(
                                ...
                                var change = this.editor.removeFormat(
                                    index,
                                    length,
                                    source
                                );
                        ...
                        },
                        {
                            ...
                            value: function updateContents(delta) {
                                ...
                                var change = this.editor.applyDelta(
                                    delta,
                                    source
                                );
                                if (range != null) {
                    ...
                    _createClass(Editor, [
                                ...
                                delta.ops.reduce(function(index, op) {
                                    ...
                                    if (op.insert != null) {
                                        if (typeof op.insert === "string") {
                                            ...
                                            var _scroll$line2 = _slicedToArray(
                                                _scroll$line,
                                                2
                                            );
                        ...
                        },
                        {
                            ...
                            value: function enable() {
                                ...
                                this.scroll.domNode.setAttribute(
                                    "contenteditable",
                                    enabled
                                );
                            }
                            ...
                            value: function update(change) {
                                ...
                                if (
                                    ...
                                    (function() {
                                        ...
                                        var oldText = new _delta2.default().insert(
                                            oldValue
                                        );
                                        ...
                                        change = diffDelta.ops.reduce(function(
                                            delta,
                                            op
                                        ) {
                                            if (op.insert) {
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function format(name, value) {
                                    ...
                                    var _descendant2 = _slicedToArray(
                                        _descendant,
                                        1
                                    );
                            ...
                            },
                            {
                                ...
                                value: function insertAt(index, value, def) {
                                    ...
                                    var _descendant4 = _slicedToArray(
                                        _descendant3,
                                        2
                                    );
                    ...
                    _createClass(Selection, [
                        ...
                        },
                        {
                            ...
                            value: function getBounds(index) {
                                ...
                                var _scroll$leaf2 = _slicedToArray(
                                    _scroll$leaf,
                                    2
                                );
                                ...
                                if (range != null) {
                                    (function() {
                                        ...
                                        indexes.forEach(function(index, i) {
                                            ...
                                            var node = void 0;
                                            var _scroll$leaf5 = _this3.scroll.leaf(
                                                index
                                            );

                                            var _scroll$leaf6 = _slicedToArray(
                                                _scroll$leaf5,
                                                2
                                            );
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                var Clipboard = (function(_Module) {
                    ...
                    function Clipboard(quill, options) {
                        ...
                        CLIPBOARD_CONFIG.concat(_this.options.matchers).forEach(
                            function(pair) {
                                _this.addMatcher.apply(
                                    _this,
                                    _toConsumableArray(pair)
                                );
                            }
                        );
                        return _this;
                            ...
                            value: function convert(html) {
                                ...
                                this.matchers.forEach(function(pair) {
                                    ...
                                    switch (selector) {
                                        ...
                                        default:
                                            [].forEach.call(
                                                _this2.container.querySelectorAll(
                                                    selector
                                                ),
                                                function(node) {
                                                    // TODO use weakmap
                                ...
                                var traverse = function traverse(node) {
                                    ...
                                    if (node.nodeType === node.TEXT_NODE) {
                                        return textMatchers.reduce(function(
                                            delta,
                                            matcher
                                        ) {
                ...
                function matchBlot(node, delta) {
                    ...
                    if (match.prototype instanceof _parchment2.default.Embed) {
                        ...
                        if (value != null) {
                            ...
                            delta = new _delta2.default().insert(
                                embed,
                                match.formats(node)
                            );
                        }
                ...
                function matchStyles(node, delta) {
                    ...
                    if (
                        style.fontWeight &&
                        computeStyle(node).fontWeight === "bold"
                    ) {
                        formats.bold = true;
                    }
                    if (Object.keys(formats).length > 0) {
                            ...
                            value: function listen() {
                                ...
                                this.quill.root.addEventListener(
                                    ...
                                    function(evt) {
                                        ...
                                        var offsetStart =
                                            _quill$scroll$leaf2[1];

                                        var _ref =
                                            range.length === 0
                                                ? [leafStart, offsetStart]
                                                : _this2.quill.scroll.leaf(
                                                      range.index + range.length
                                                  );
                            ...
                            },
                            {
                                ...
                                value: function formats(domNode) {
                                    ...
                                    if (domNode.hasAttribute("width"))
                                        formats["width"] = domNode.getAttribute(
                                            "width"
                                        );
                                    return formats;
                                }
            ...
            /***/ function(module, exports) {
                ...
                var Tooltip = (function() {
                    function Tooltip(quill, boundsContainer) {
                        ...
                        var offset = parseInt(
                            window.getComputedStyle(this.root).marginTop
                        );
